package com.riwi.prueba_desempeno_spring_boot_multimedia.api.error_handler;

import com.riwi.prueba_desempeno_spring_boot_multimedia.api.dto.errors.BaseErrorResp;
import com.riwi.prueba_desempeno_spring_boot_multimedia.api.dto.errors.ErrorsResp;
...
@ResponseStatus(code = HttpStatus.BAD_REQUEST) // Status de error del controlador
public class BadRequestController {

    /*
     * MethodArgumentNotValidException es la excepción que activa la librería
     * de validación
     */
